...
# find the current directory using below logick
"""
/*
...
current_path = r"c:\Users\gnana\Desktop\Task"
...
#split all file extensions from the current directory path
...
#create all files to organise files
...
#move all files to their respective folders
    ...
    print("File segrigation is Completed based on Extension")


#organizeByExtention(directory)
...
def organizeBySize(path):
    ...
    # segrigation and folder creation according to size
    for i in file_size0:
...
# segrigation and folder creation according to date
